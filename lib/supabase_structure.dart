...
/// A Calculator.
class SupabaseStructure {
  // static Future<void> setDbVersion(int version) async {
  //   await SupabaseSharedData.setLocalDbVersion(version);
  // }

  // static int get dbVersion => SupabaseSharedData.getLocalDbVersion;
}
